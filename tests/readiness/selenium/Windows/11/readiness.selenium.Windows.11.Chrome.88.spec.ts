// tests/readiness/selenium/Windows/11/readiness.selenium.Windows.11.Chrome.88.spec.ts
    ...
    driver = await new Builder()
      ...
      .withCapabilities({
        ...
        "bstack:options": {
          ...
          buildName: "Selenium.Windows.11.Chrome.88.Readiness",
          sessionName: "Windows 11 / Chrome 88",
          video: false,
          networkLogs: true,
          consoleLogs: "verbose",
        },
