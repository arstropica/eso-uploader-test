// tests/readiness/selenium/IOS/16/iPad/10Th/Safari/latest/readiness.selenium.IOS.16.iPad.10Th.Safari.latest.spec.ts
    ...
    driver = await new Builder()
      ...
      .withCapabilities({
        ...
        "bstack:options": {
          ...
          buildName: "Selenium.IOS.16.iPad.10Th.Safari.latest.Readiness",
          sessionName: "IOS 16 / iPad 10Th / Safari latest",
          video: false,
          networkLogs: true,
          consoleLogs: "verbose",
        },
