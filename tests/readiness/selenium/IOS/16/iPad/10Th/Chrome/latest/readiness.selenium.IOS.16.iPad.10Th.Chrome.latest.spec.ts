// tests/readiness/selenium/IOS/16/iPad/10Th/Chrome/latest/readiness.selenium.IOS.16.iPad.10Th.Chrome.latest.spec.ts
    ...
    driver = await new Builder()
      ...
      .withCapabilities({
        ...
        "bstack:options": {
          ...
          buildName: "Selenium.IOS.16.iPad.10Th.Chrome.latest.Readiness",
          sessionName: "IOS 16 / iPad 10Th / Chrome latest",
          video: false,
          networkLogs: true,
          consoleLogs: "verbose",
        },
